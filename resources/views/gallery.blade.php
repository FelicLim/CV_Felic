        	...
        	<div class="container">
        		<div class="gallery_f_inner row imageGallery1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="img/gallery/project-7.png" alt="">
        						<a class="light" href="img/gallery/project-7.png"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<h4>Painting Vector</h4>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="img/gallery/project-8.png" alt="">
        						<a class="light" href="img/gallery/project-8.png"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<h4>Hotdog Illustration</h4>
        						<p>Workshop Project</p>
        					</div>
        				</div>
        			</div>
                    <div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="img/gallery/project-9.png" alt="">
        						<a class="light" href="img/gallery/project-9.png"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<h4>LIT 2022 Logo</h4>
        						<p>Event Project</p>
