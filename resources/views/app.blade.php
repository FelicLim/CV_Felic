...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="tampilkrs" class="nav-link">Lihat KRS</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="app" class="nav-link">Lihat KHS</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Lihat KHS</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home">Home</a></li>
              <li class="breadcrumb-item active">Lihat KHS</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <table class="table table-hover">
                  ...
                  <?php
                              ...
                              while ($no<4) {
                                  ...
                                  $nilai = DB::table('khs_detail')
                                  ->where('kode_khs_detail', 100+$no)
                                  ->value('nilaiHuruf');
                                  ...
                                  echo "<td style='text-align:left'>".$nilai."</td>";
                                  echo "</tr>";
